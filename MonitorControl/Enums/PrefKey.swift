...
enum PrefKey: String {
  ...
  /// JSON-encoded array of presets for display
  case presets

  /// Were the built-in presets seeded for display?
  case presetsSeeded

  /// Was the Reading Mode brightness bump migration applied for display?
  case readingModeBrightnessMigrated

  /// Was the Reading Mode brightness/contrast adjustment migration applied for display?
  case readingModeContrastMigrated
